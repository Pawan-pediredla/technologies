               ...
               <div className="mb-2" >
                <Dropdown as={ButtonGroup}  size={"lg"}>
                    ...
                    <Dropdown.Menu>
                        ...
                        <Dropdown.Item eventKey="2" onClick={()=>setTheme("secondary")}>
                          
                            Secondary
                        </Dropdown.Item>
                        <Dropdown.Item eventKey="3 " onClick={()=>setTheme("danger")}  >
                            Danger
                        </Dropdown.Item>
                        <Dropdown.Item eventKey="4" onClick={()=>setTheme("success")} >
                            Success 
                        </Dropdown.Item><Dropdown.Item eventKey="4" onClick={resetTheme}>
            Default Theme
          </Dropdown.Item>
                    </Dropdown.Menu>  
                </Dropdown>
